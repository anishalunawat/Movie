...
public class MovieDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            ...
            title = b.getStringExtra("title");
            poster_path = b.getStringExtra("poster_path");
            release_date = b.getStringExtra("release_date");
            overview = b.getStringExtra("overview");
            rating = b.getStringExtra("rating");
